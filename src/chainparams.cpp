...
{
    const char* pszTimestamp = "7nm ASICs Will Bring Bitcoin Mining to a Whole New Level 2018";
...
public:
	...
	startNewChain = false;
        ...
        genesis = CreateGenesisBlock( 1517216598, 739783, 0x1e0ffff0, 1, 50 * COIN);
...
public:
	...
	if(!startNewChain) {
        assert(consensus.hashGenesisBlock == uint256S("0x000000c16d7617ff5da35c25c549f6855a3eefb1b1fb6c6a9ce5eb1094f935b9"));
        assert(genesis.hashMerkleRoot == uint256S("0x499e917edcfff42df9af770c37d42c397d35c19aed728848d9176232e41ab1dd"));
	}
...
public:
	...
	startNewChain = false;
        ...
        genesis = CreateGenesisBlock(1517216598, 739783, 0x207fffff, 1, 50 * COIN);
        if(startNewChain == true) {
        	MineGenesis(genesis, consensus.powLimit, true);
	}
